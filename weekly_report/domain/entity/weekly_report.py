...
from sqlalchemy import BigInteger, Column, Integer, Text, Date, DateTime, Numeric, JSON, UniqueConstraint
from sqlalchemy.sql import func
from moodping.config.mysql_config import Base

class WeeklyReport(Base):
    __tablename__ = "weekly_report"
    __table_args__ = (UniqueConstraint("user_id", "week_start", name="uk_user_week"), {"extend_existing": True})
